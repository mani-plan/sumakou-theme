...
<div class="page">
  ...
  <section class="section inner narrow policy">
  <h2 class="cont-title">プライバシーポリシー</h2>

    <h3>はじめに</h3>
    <p>株式会社 住まい工房まつやま（以下、「当社」）は、各種サービスのご提供にあたり、お客様の個人情報をお預かりしております。<br>
    当社は個人情報を保護し、お客様に更なる信頼性と安心感をご提供できるように努めて参ります。<br>
    当社は、個人情報に関する法令を遵守し、個人情報の適切な取り扱いを実現致します。</p>

    <h3>個人情報の取得について</h3>
    <p>当社は、偽りその他不正の手段によらず適正に個人情報を取得致します。なお、次のような場合に必要な範囲で個人情報を収集する場合があります。</p>
    <ul>
      <li>お問い合わせ・ご相談</li>
      <li>ご予約</li>
    </ul>
    ...
    <ul>
    <li>お問い合わせ・ご相談に対するご回答のご連絡のため</li>
    <li>ご予約の確認のご連絡のため</li>
    ...
    当社の個人情報の取り扱いにつきまして、上記の請求・お問い合わせ等ございましたら、下記までご連絡くださいますようお願い申し上げます。</p>

    <h3>連絡先</h3>
    <p>名称：株式会社 住まい工房まつやま<br>
    住所：〒791-8006　愛媛県松山市安城寺町1136番地1<br>
    TEL：089-904-4325</p>

    <h3>その他の注意事項</h3>
    <p>当社が運営するコンテンツや掲載広告などからリンクされている第三者のサイト及びサービスは、当社とは独立した個人情報の保護に関する規定やデータ収集の規約を定めています。<br>
    当サイトはこれらの規約や活動に対していかなる義務や責任も負いません。</p>

    <h3>個人情報の管理方法の継続的改善について</h3>
